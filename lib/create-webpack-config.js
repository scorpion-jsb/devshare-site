...
function createWebpackConfig(options) {
  ...
  var resolve = {
    alias: {
      ...
      'kyper-grout': path.resolve(__dirname, '..', 'node_modules/kyper-grout/dist/grout.min.js'),
      'firebase': path.resolve(__dirname, '..', 'node_modules/re-base/node_modules/firebase/lib/firebase-web.js')
    },
    extensions: ['', '.js']
  };
